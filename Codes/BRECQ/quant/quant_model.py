...
class QuantModel(nn.Module):
    ...
    def __init__(self, model: nn.Module, weight_quant_params: dict = {}, act_quant_params: dict = {}, ignore_last: bool=False):
        super().__init__()
        search_fold_and_remove_bn(model)
        self.model = model
        self.ignore_fc_layer = ignore_last
    ...
    def quant_module_refactor(self, module: nn.Module, weight_quant_params: dict = {}, act_quant_params: dict = {}):
        ...
        for name, child_module in module.named_children():
            if type(child_module) in specials:
                ...
                if 'fc' in name and self.ignore_fc_layer:
                    continue
    ...
    def set_last_layer_to_4bit(self):
        module_list = []
        for m in self.model.modules():
            if isinstance(m, QuantModule):
                module_list += [m]    
        module_list[-1].weight_quantizer.bitwidth_refactor(4)
