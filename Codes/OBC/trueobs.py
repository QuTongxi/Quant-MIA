...
class TrueOBS:
    ...
    def __init__(self, layer, rel_damp=0):
        ...
        # modfied here
        self.layer.delta = None
        self.layer.zero_point = None
        self.layer.n_levels = None
    ...
    def quantize(self, parallel=32):
        ...
        # modified here
        self.layer.delta = nn.Parameter(self.quantizer.scale)
        self.layer.zero_point = nn.Parameter(self.quantizer.zero)
        self.layer.n_levels = self.quantizer.maxq.float()
